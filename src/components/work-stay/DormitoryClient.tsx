...
export function DormitoryClient() {
  ...
  const packages = [
    ...
    },
    {
      ...
      price: '₹9,999',
      unit: 'month',
      desc: 'Our most popular tier: complete month-to-month living and working in Sector 45 Gurugram.',
      features: [
        'Guaranteed dedicated bed pod for the entire month',
        'Personal lockable wardrobe closet',
        '24/7 unrestricted high-speed coworking access',
        '2x Daily room cleaning & weekly linen change',
        'Discounted cafeteria breakfast & dinner meal plans',
        'Zero brokerage & minimal refundable security deposit',
      ],
      popular: true,
    },
    {
      name: 'Quarterly Builder Pass',
      price: '₹26,999',
      unit: '3 months (₹8,999/mo)',
      ...
      features: [
        ...
        '4 complimentary hours of boardroom credits / mo',
        'Postal mail & delivery handling assistance',
      ],
      popular: false,
    },
  ];
