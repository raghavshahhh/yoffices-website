...
export function WorkStayClient() {
  ...
  const shiftPlans = [
    {
      name: 'Day Shift Workspace + Rest',
      hours: '8:00 AM — 8:00 PM',
      price: '₹7,999',
      unit: 'month',
      desc: 'Ideal for daytime startup founders, remote engineers, and freelancers needing daytime desk and nap pod access.',
      features: [
        ...
        'Discounted cafeteria meal plans',
      ],
      popular: false,
    },
    {
      name: '24x7 Full Co-Living Stay',
      hours: '24 Hours / 7 Days Round-the-Clock',
      price: '₹14,999',
      unit: 'month',
      desc: 'Complete all-inclusive co-living residency combining dedicated dormitory bunk, locker, and 24/7 workspace.',
      features: [
        ...
        'Daily housekeeping & weekly fresh linen changes',
        'Hot water showers & sanitized washrooms',
        'Full access to gourmet pantry & kitchen amenities',
      ],
      popular: true,
    },
    {
